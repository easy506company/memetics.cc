  ...
  return (
    <div className="prose dark:prose-invert max-w-4xl mx-auto py-12">
      <p className="mb-6 text-sm text-gray-500 dark:text-gray-400">
        ...
        <a href="https://github.com/easy506company/awesome-meme" target="_blank" rel="noopener noreferrer" className="underline">
          https://github.com/easy506company/awesome-meme
        </a>
      </p>
